...
# ------------------ DISCONTINUED ---------------------
# Preferably use data_prep to load new data from SQL database instead
...
## SAVE DATA ----
save(simpson_HE, biplane_HE, operator_wide, method_wide, LA_dm, tibia_lengths, file = "Data handling/LA_data_old.Rdata")
save.image()
